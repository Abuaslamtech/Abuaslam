...
const FilterButton = ({ tag, isActive, onClick }: filterButtonType) => (
  <button
    onClick={onClick}
...
const ProjectLink = ({ url, label, isActive, onClick }: projectLinkType) => (
  <a
    href={url}
    target="_blank"
...
const ProjectCard = ({ project, index }: projectCardType) => {
...
const EmptyState = ({ onReset }: emptyStateType) => (
...
const LoadMoreButton = ({ onClick }: loadMoreButtonType) => (
  <button
    onClick={onClick}
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          <div className="relative z-10 pb-8 text-light flex flex-col w-full md:w-4/5 lg:w-3/5 gap-6 h-full justify-center py-4 ">
            ...
            <p className="text-light/80 mt-8 max-w-2xl">
              ...
              represents my dedication to creating intuitive, efficient, and
